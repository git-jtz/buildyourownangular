...
describe("Scope", function(){//describe work as grouping
	...
	describe("Events", function() {
		...
		it("passes an event object with a name to listeners on emit", function() {
		...
		it("passes the same event object to each listener on emit", function() {
		var listener1 = jasmine.createSpy();
		var listener2 = jasmine.createSpy();
		scope.$on('someEvent', listener1);
		scope.$on('someEvent', listener2);
		...
		it("does not skip the next listener when removed on ", function() {
		var deregister;
